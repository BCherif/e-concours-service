...
public class JwtWebSecurity extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(JwtConstants.COMPETITION_URL, JwtConstants.ESTABLISHMENT_URL, JwtConstants.CANDIDACY_URL, JwtConstants.MAIL_URL, JwtConstants.CANDIDATE2_URL, JwtConstants.CANDIDATE_URL)
                .permitAll()
                .anyRequest()
                .authenticated()
                .and()
